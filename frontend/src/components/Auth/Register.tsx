...
const Register: React.FC = () => {
  ...
  return (
  <main className="relative min-h-screen w-screen overflow-hidden bg-slate-950">
    <AnimatedBackdrop variant="dark" />

    <div className="relative flex min-h-screen w-full items-center justify-center px-6 py-8  lg:px-16">
      <div className="grid w-full  gap-6 lg:grid-cols-2">
        ...
        <motion.article
          ...
          className="hidden rounded-3xl border border-sky-200/25 bg-slate-900/35 p-10 text-white backdrop-blur lg:flex lg:flex-col lg:justify-center"
        >
